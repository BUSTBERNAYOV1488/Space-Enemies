/// @description em_init(section_num,font,pixel_space,cursor_char,start_x,start_y,halign,valign,color,title,title_separation,title_color,title_font,title_xscale,title_yscale,sound);
/// @param section_num
/// @param font
/// @param pixel_space
/// @param cursor_char
...
/// @param color
/// @param title
/// @param title_separation
/// @param title_color
/// @param title_font
/// @param title_xscale
/// @param title_yscale
/// @param sound
function em_init(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10, argument11, argument12, argument13, argument14, argument15) {
